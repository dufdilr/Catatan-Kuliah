...
\end{align*}
$$
Jelas $u + w, \alpha \cdot u \in \left< v_{1}, v_{2}, \cdots, v_n \right>$ maka berdasarkan [[Buat Backup/Semester 4 1/Aljabar Linear/Ruang Vektor Umum/Karakterisasi Subruang]] terbukti bahwa $\left< v_{1}, v_{2}, \cdots, v_n \right>$ membentuk subruang dari $V$.
