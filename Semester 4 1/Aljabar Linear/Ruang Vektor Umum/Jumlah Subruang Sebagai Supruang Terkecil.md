...
$$
Artinya $V_1 + V_2 + \cdots + V_n$ takkosong. Berdasarkan sifat [[Buat Backup/Semester 4 1/Aljabar Linear/Ruang Vektor Umum/Ruang Vektor]] maka setiap unsur di $V_1 + V_2 + \cdots + V_n$ juga unsur $V$. Berarti $V_1 + V_2 + \cdots + V_n$ adalah subhimpunan tak-kosong dari $V$
...
\end{align*}
$$
Perhatikan bahwa ${v_i},\ {w_i} \in V_i$ sehingga $\left({v_i}+{w_i}\right), \lambda {v_i} \in V_i$. Artinya $\left({v}+{w}\right), \lambda {v} \in V_1 + V_2 + \cdots V_n$. Berdasarkan [[Buat Backup/Semester 4 1/Aljabar Linear/Ruang Vektor Umum/Karakterisasi Subruang]] maka $V_1 + V_2 + \cdots + V_n$ adalah subruang dari $V$.
...
***
## Definition Used:
* [[Buat Backup/Semester 4 1/Aljabar Linear/Ruang Vektor Umum/Ruang Vektor]]
