...
$$
\text{Ker}\left({T}\right) := \{ v \in V \ | \ T(v) = \mathbf{0_W} \}
$$
Secara khusus, untuk $\mathbf{A} \in M_{m \times n}(\mathbb{F})$, definisikan $\text{Ker}(\mathbf{A}) = \text{Ker}(T_A)$ dengan $T_A$ adalah pemetaan linear yang [[Buat Backup/Semester 4 1/Aljabar Linear/Matriks dan Pemetaan Linear/Matriks Sebagai Pemetaan Linear|didefinisikan]] oleh $\mathbf{A}$.
