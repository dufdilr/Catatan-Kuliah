...
Perhatikan karena  $[a_1]_n = [a_2]_n$ dan $[b_{1}]_{n} = [b_{2}]_{n}$ maka $n \mid (a _1 - a_2)$ dan $n \mid (b_{1} - b_{2})$. Berdasarkan [[Sifat Keterbagian#^ab6a93|sifat keterbagian]] maka $n \mid (a_{1}-a_{2}) + (b_{1}-b_{2}) = (a_1 + b_1) - (a_2 + b_2)$. Terbukti
$$
\begin{align*}
...
Perhatikan karena  $[a_1]_n = [a_2]_n$ dan $[b_{1}]_{n} = [b_{2}]_{n}$ maka $n \mid (a _1 - a_2)$ dan $n \mid (b_{1} - b_{2})$. Berdasarkan [[Sifat Keterbagian#^ab6a93|sifat keterbagian]] maka $n|b_{1}(a_{1}-a_{2})+a_{2}(b_{1}-b_{2}) = a_{1}b_{1} - a_{2}b_{2}$. Artinya $[a_{1}b_{1}]_{n} = [a_{2}b_{2}]_{n}$ Terbukti
$$
\begin{align*}
