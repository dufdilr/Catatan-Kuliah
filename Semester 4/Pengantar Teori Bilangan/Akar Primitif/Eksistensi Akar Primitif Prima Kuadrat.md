...
\text{ord}_{p^2}(s) \neq p-1
$$
	Dapat disimpulkan $\text{ord}_{p^2}(s) = p(p-1) = \varphi(p^2)$. Maka $s = r+p$ adalah akar primitif dari $p^2$.
* **Jika $k = p(p-1)$**
	Maka $\text{ord}_{{p^2}}(r) = k = p(p-1) = \varphi(p^2)$. Maka $r$ adalah akar primitif dari $p^2$.

Terbukti  $r$ atau $r+p$ adalah akar primitif dari $p^2$.
