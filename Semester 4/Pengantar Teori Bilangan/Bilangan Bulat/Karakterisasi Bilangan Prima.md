...
* **Langkah Induksi:**
    ...
    2.  Jika $p \nmid a_n$, karena  adalah bilangan prima dan  maka $(p, a_n) = 1$**.
        ...
        Berdasarkan[[Buat Backup/Semester 4/Pengantar Teori Bilangan/Bilangan Bulat/Hukum Pembatalan Keterbagian| sifat pembatalan]] dapat disimpulkan
        $$p \mid (a_1a_2\cdots a_{n-1})$$
        Berdasarkan hipotesis induksi,  maka haruslah $p \mid a_i$ untuk suatu $i \in \{1, 2, \dots, n-1\}$.

Dalam kedua kasus, kita menemukan bahwa $p$ membagi salah satu $a_i$. Berdasarkan [[Buat Backup/Prerquested/Prinsip Induksi Matematika|prinsip induksi matematika]], teorema ini terbukti benar. ■
