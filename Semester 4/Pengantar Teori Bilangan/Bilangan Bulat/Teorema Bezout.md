...
Berdasarkan [[Aksioma Urutan Sempurna]], himpunan $V$ memiliki elemen terkecil $c$. Karena $c \in V$, maka $c$ dapat ditulis sebagai:
...
Berdasarkan [[Algoritma Pembagian]], ada $q_1, r_1 \in \mathbb{Z}$ dengan $0 \le r_1 < c$ sehingga $a = q_1c + r_1$. Perhatikan bahwa
...
Misalkan $d$ adalah sembarang pembagi bersama dari $a$ dan $b$ ($d \mid a$ dan $d \mid b$). Berdasarkan [[Sifat Keterbagian#^ab6a93|sifat kelinieran keterbagian]], $d$ harus membagi setiap kombinasi linear dari $a$ dan $b$. Maka:
$$d \mid (s_1a+t_1b)$$
Ini berarti $d \mid c$.
...
Karena $c \mid c'$ dan $c' \mid c$, serta $c$ dan $c'$ keduanya adalah bilangan asli (positif), [[Sifat Keterbagian#^d21346|maka]] satu-satunya kemungkinan adalah $c=c'$.
