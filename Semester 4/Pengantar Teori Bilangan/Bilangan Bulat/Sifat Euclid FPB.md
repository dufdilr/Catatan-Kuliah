...
Lebih lanjut, Misal $d$ suatu bilangan bulat sehingga $d \mid b$ dan $d \mid r$. Maka, $d \mid (bq + r) = a$    Berdasarkan [[Teorema Bezout|Identitas Bezout]], terdapat $s, t \in \mathbb{Z}$ sehingga $c = sa + tb$. Karena $d \mid a$ dan $d \mid b$ maka $d \mid (sa + tb) = c$.
