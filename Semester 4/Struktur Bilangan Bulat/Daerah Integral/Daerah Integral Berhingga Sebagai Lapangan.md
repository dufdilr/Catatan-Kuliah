...
Berdasarkan [[Buat Backup/Prerquested/Relasi dan Fungsi/Prinsip Sarang Merpati|prinsip sarang merpati]], ada $i < j$ (dengan $i, j \le n+1$) sehingga $a^i = a^j$. Perhatikan bahwa
$$
\begin{align*}
a^i &= a^j \\
a^i &= a^i \cdot a^{j - i} \\
