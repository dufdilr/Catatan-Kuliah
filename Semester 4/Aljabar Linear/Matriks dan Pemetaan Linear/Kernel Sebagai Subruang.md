...
Berdasarkan [[Buat Backup/Semester 4/Aljabar Linear/Matriks dan Pemetaan Linear/Pemetaan Linear Vektor Nol]] maka $T(\mathbf{0_V}) = \mathbf{0_W}$. Artinya $\mathbf{0_V} \in \text{Ker}\left({T}\right)$. Berarti $\text{Ker}\left({T}\right) \neq 0$. Lebih lanjut, ambil $x, y \in \text{Ker}\left({(T)}\right)$ dan $\alpha \in \mathbb{F}$. Perhatikan bahwa berdasarkan [[Buat Backup/Semester 4/Aljabar Linear/Ruang Vektor Umum/Sifat Ruang Vektor]] berlaku
$$
\begin{align*}
