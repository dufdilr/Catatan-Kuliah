...
* **($\Leftarrow$): Misalkan $\lim_{n\to\infty} d(x_n, y_n) = 0$.**
    ...
    \end{align*}
    $$
    Karena untuk setiap $\varepsilon > 0$ berlaku $d(x, y)<\varepsilon$ [[Buat Backup/Semester 5/Pengantar Analisis Real/Bilangan Real/Teorema Karakterisasi Nol|maka]] $d(x, y) = 0$.
