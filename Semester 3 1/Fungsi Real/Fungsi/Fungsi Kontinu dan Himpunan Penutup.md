...
Misalkan $f$ kontinu.
    ...
    Karena $\overline{f(E)}$ [[Buat Backup/Semester 3/Fungsi Real/Topologi/Penutup Himpunan|himpunan tutup]] dan $f$ fungsi kontinu maka berdasarkan [[Buat Backup/Semester 3 1/Fungsi Real/Fungsi/Fungsi Kontinu dan Himpunan Tutup|teorema]], $f^{-1}\left(\overline{f(E)}\right)$ juga himpunan tutup. Berdasarkan [[Buat Backup/Semester 3/Fungsi Real/Topologi/Sifat Penutup Himpunan]] didapatkan
