...
Berarti $\text{diam}(E_n) \to 0$. Berdasarkan [[Buat Backup/Semester 3/Fungsi Real/Ruang Lengkap/Diameter Himpunan Penutup|teorema]] maka $\text{diam}(\overline{E_n}) \to 0$
