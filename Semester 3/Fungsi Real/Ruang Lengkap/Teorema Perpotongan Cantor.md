...
Perhatikan bahwa untuk setiap $m \in \mathbb{N}: \ \{x_n\}_{n \ge m} \subseteq F_m$. Karena $x_n \to a$ maka subbarisan $\{x_n\}_{n \ge m}$ [[Limit Subbarisan|juga konvergen ke]] $a$. Berarti $a \in \overline{F_m}$. Karena $F_m$ himpunan tutup berarti $a \in F_m$. Karena berlaku untuk setiap $m \in \mathbb{N}$ maka
    $$a \in \bigcap F_n$$
...
Ambil suatu barisan cauchy $\{x_n\}\subseteq X$. Tinjau barisan himpunan $E_n := \{x_k \ | \ k \ge n\}$. Jelas $E_{n +1} \subseteq E_n$. Berdasarkan [[Sifat Penutup Himpunan#^738419|teorema]] didapatkan $\overline{E_{n+1}} \subseteq\overline{E_n}$
...
Berarti $\text{diam}(E_n) \to 0$. Berdasarkan [[Diameter Himpunan Penutup|teorema]] maka $\text{diam}(\overline{E_n}) \to 0$
