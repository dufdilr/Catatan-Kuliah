...
## [[Buat Backup/Semester 3/Fungsi Real/Ruang Metrik/Ruang Metrik|Definisi Ruang Metrik]]
...
## [[Buat Backup/Semester 3/Fungsi Real/Ruang Metrik/Ruang Metrik Standar]]
...
## [[Buat Backup/Semester 3/Fungsi Real/Ruang Metrik/Metrik Norm|Ruang Bernorm Sebagai Metrik]]
...
## [[Buat Backup/Semester 3/Fungsi Real/Ruang Metrik/Norm Hasil Kali Dalam]]
Misalkan $\langle\cdot,\cdot\rangle$ adalah **hasil kali dalam** pada $\mathbb{V}$. Maka
$$\|u\| = \sqrt{\langle u,u\rangle}$$
adalah suatu **norm** pada $\mathbb{V}$.

## [[Buat Backup/Semester 3/Fungsi Real/Ruang Metrik/Ketaksamaan Cauchy-Schwarz]]
...
## [[Buat Backup/Semester 3/Fungsi Real/Barisan/Ketunggalan Limit]]
...
## [[Buat Backup/Semester 3/Fungsi Real/Barisan/Barisan Cauchy Terbatas]]
Jika $(x_n) \subseteq \mathbb{X}$ adalah barisan cauchy maka $(x_{n})$ merupakan barisan terbatas.
## [[Buat Backup/Semester 3/Fungsi Real/Barisan/Barisan Konvergen Cauchy]]
Jika $(x_n) \subseteq \mathbb{X}$ adalah barisan konvergen ke $x \in \mathbb{X}$ maka $(x_n)$ merupakan barisan cauchy.
## [[Buat Backup/Semester 3/Fungsi Real/Barisan/Kesetaraan Limit Barisan]]
...
## [[Buat Backup/Semester 3/Fungsi Real/Barisan/Limit Subbarisan]]
Setiap subbarisan dari suatu barisan konvergen juga konvergen ke nilai yang sama.

## [[Buat Backup/Semester 3/Fungsi Real/Barisan/Limit Subbarisan Cauchy]]
...
## [[Buat Backup/Semester 3/Fungsi Real/Barisan/Kekonvergenan di Rn]]
...
Misalkan $(X, d)$ adalah [[Buat Backup/Semester 3/Fungsi Real/Ruang Metrik/Ruang Metrik|ruang metrik]]. Misalkan pula $a \in X$ dan $r > 0$. Definisikan **bola buka** berpusat di $a$ dengan jari-jari $r$ sebagai
$$
...
Misalkan metrik $(X, d)$ dan subhimpunan $E \subseteq X$. Himpunan $E$ dikatakan **himpunan buka** (di $X$) jika untuk setiap $a \in E$, $a$ merupakan [[Buat Backup/Semester 3/Fungsi Real/Topologi/Titik Interior]] dari $E$.

## [[Buat Backup/Semester 3/Fungsi Real/Topologi/Himpunan Tutup]]
Misalkan metrik $(X, d)$ dan subhimpunan $F \subseteq X$. Himpunan $F$ dikatakan **himpunan tutup** (di $X$) jika $F^c$ merupakan [[Buat Backup/Semester 3/Fungsi Real/Topologi/Himpunan Buka|himpunan buka]].

## [[Buat Backup/Semester 3/Fungsi Real/Topologi/Topologi Himpunan Buka]]
...
## [[Buat Backup/Semester 3/Fungsi Real/Topologi/Topologi Himpunan Tutup]]
Misalkan $(X, d)$ ruang metrik
...
## [[Buat Backup/Semester 3/Fungsi Real/Topologi/Sifat Himpunan Titik Interior]]
...
### [[Buat Backup/Semester 3/Fungsi Real/Topologi/Subhimpunan Buka Maksimum]]
...
## [[Buat Backup/Semester 3/Fungsi Real/Topologi/Titik Limit]]
...
### [[Buat Backup/Semester 3/Fungsi Real/Topologi/Sifat Titik Limit]]
...
## [[Buat Backup/Semester 3/Fungsi Real/Topologi/Sifat Himpunan Titik Limit]]
...
### [[Buat Backup/Semester 3/Fungsi Real/Topologi/Himpunan Tutup dan Himpunan Titik Limit]]
...
### [[Buat Backup/Semester 3/Fungsi Real/Topologi/Sifat Penutup Himpunan]]
...
## [[Buat Backup/Semester 3/Fungsi Real/Fungsi/Limit Fungsi dan Barisan]]
...
## [[Buat Backup/Semester 3/Fungsi Real/Fungsi/Fungsi Kontinu dan Barisan]]
...
## [[Buat Backup/Semester 3/Fungsi Real/Fungsi/Fungsi Kontinu dan Himpunan Buka]]
...
## [[Buat Backup/Semester 3/Fungsi Real/Fungsi/Fungsi Kontinu dan Himpunan Tutup]]
Misalkan $(X, d_X)$ dan $(Y, d_Y)$ ruang metrik dan $A \subseteq X$. Misalkan pula fungsi $f: A \to Y$.  Fungsi $f$ kontinu pada himpunan $A$ **jika dan hanya jika** berlaku
$$\forall \ \mathcal{F} \subseteq Y \text{ himpunan tutup di } Y \text{ maka } f^{-1}(\mathcal{F}) \text{ adalah himpunan tutup relatif di } A$$
## [[Buat Backup/Semester 3/Fungsi Real/Fungsi/Fungsi Kontinu dan Himpunan Penutup]]
...
## [[Buat Backup/Semester 3/Fungsi Real/Fungsi/Kontinu Seragam]]
...
## [[Buat Backup/Semester 3/Fungsi Real/Fungsi/Kekontinuan Limit Barisan Fungsi Kontinu]]
...
## [[Buat Backup/Semester 3/Fungsi Real/Fungsi/Pertukaran Limit]]
...
## [[Buat Backup/Semester 3/Fungsi Real/Ruang Lengkap/Subruang Lengkap]]
...
## [[Buat Backup/Semester 3/Fungsi Real/Ruang Lengkap/Subruang Lengkap Tutup]]
Misalkan $(X,d)$ suatu metrik dan $A \subseteq X$. Jika $A$ adalah subruang lengkap maka $A$ himpunan tutup.
## [[Buat Backup/Semester 3/Fungsi Real/Ruang Lengkap/Subhimpunan Tutup di Ruang Lengkap]]
...
## [[Buat Backup/Semester 3/Fungsi Real/Ruang Lengkap/Teorema Kontraksi Banach]]
...
### [[Buat Backup/Semester 3/Fungsi Real/Ruang Lengkap/Diameter Himpunan Penutup]]
Misalkan $(X, d)$ suatu ruang metrik dan himpunan tak-kosong $F$ maka berlaku
$$\text{diam}(F) = \text{diam}(\overline{F})$$

## [[Buat Backup/Semester 3/Fungsi Real/Ruang Lengkap/Teorema Perpotongan Cantor]]
...
## [[Buat Backup/Semester 3/Fungsi Real/Ruang Lengkap/Kelengkapan dan Himpunan Padat]]
Misalkan $X$ himpunan padat di $Y$. Jika setiap barisan cauchy di $X$ konvergen di $Y$ maka $Y$ lengkap.
## [[Buat Backup/Semester 3/Fungsi Real/Ruang Lengkap/Teorema Pelengkap Cantor]]
Setiap ruang metrik memiliki pelengkap.

---
# Ruang Banach

## [[Buat Backup/Semester 3/Fungsi Real/Ruang Banach/Ruang Banach|Definisi Ruang Banach]]
...
$$
## [[Buat Backup/Semester 3/Fungsi Real/Ruang Banach/Deret Konvergen Mutlak]]
