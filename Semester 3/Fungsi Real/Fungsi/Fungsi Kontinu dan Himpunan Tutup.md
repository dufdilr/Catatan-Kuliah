...
### **$\Rightarrow:$**
Misalkan $f$ kontinu di $A$. Ambil himpunan tutup $F \subseteq Y$. Perhatikan bahwa $F^c$ adalah himpunan buka. Berdasarkan [[Buat Backup/Semester 3/Fungsi Real/Fungsi/Fungsi Kontinu dan Himpunan Buka|teorema]] $f^{-1}(F^c)$ juga himpunan buka di $A$.
...
Berdasarkan [[Buat Backup/Semester 3/Fungsi Real/Fungsi/Fungsi Kontinu dan Himpunan Buka|teorema]] terbukti bahwa $f$ kontinu.
