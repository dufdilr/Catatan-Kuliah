...
## Bukti
### $\Rightarrow$
Misalkan $G$ suatu pohon dan $u, v \in V(G)$. Karena $G$ pohon [[Buat Backup/Semester 5/Pengantar Teori Graf/2. Tree/Pohon Graf Sederhana|maka]] $G$ adalah graf sederhana dan terhubung. Karena $G$ [[Buat Backup/Semester 5/Pengantar Teori Graf/1. Pengantar/Graf Terhubung|terhubung]] maka terdapat $(u, v)-$path. Akan ditunjukkan ketunggalan.
...
Perhatikan bahwa $N \neq \emptyset$ dan $N\subseteq \mathbb{N}$, maka berdasarkan [[Buat Backup/Semester 4/Pengantar Teori Bilangan/Bilangan Bulat/Aksioma Urutan Sempurna]] terdapat unsur terkecil $i$. Lebih lanjut, karena $i - 1 < i$ maka $i - 1 \notin N$. Berarti, $v_{i-1} \in P_2$. Misalkan $v_{i-1} = w_j$. Tinjau himpunan
$$N_{2} = \{ n \in \mathbb{N} : n > i, v_{n} \in P_{2} \}$$
dengan $v_k = v$ maka jelas $k \in N_2$. Berarti $N_2 \neq \emptyset$ dan $N_2 \subseteq \mathbb{N}$. Berdasarkan [[Buat Backup/Semester 4/Pengantar Teori Bilangan/Bilangan Bulat/Aksioma Urutan Sempurna]], terdapat unsur terkecil $p$. Perhatikan bahwa $v_p \in P_2$. Misalkan $v_p = w_q$. Konstruksi
$$
...
### $\Leftarrow$
Misalkan $G$ suatu graf sehingga untuk setiap $u, v \in V(G)$ terdapat $(u, v)-$path secara tunggal. Dapat disimpulkan $G$ terhubung. Lebih lanjut, akan ditunjukkan $G$ [[Buat Backup/Semester 5/Pengantar Teori Graf/2. Tree/Graf Asiklik|asiklik]].
