...
3. **Aksioma Urutan**
	...
	1. Untuk setiap $a, b \in \mathbb{P}$ berlaku $a + b \in \mathbb{P}$. ^d869f3
	2. Untuk setiap $a, b \in \mathbb{P}$ berlaku $a \times b \in \mathbb{P}$. ^b8b0f5
	3. Untuk setiap $a \in \mathbb{R}$ berlaku tepat satu: $a \in \mathbb{P}$, atau $-a \in \mathbb{P}$, atau $a = 0$.

4. **Aksioma Kelengkapan**
	Untuk setiap $A \subseteq \mathbb{R}$ yang terbatas di bawah maka terdapat $a \in \mathbb{R}$ sehingga $a = \inf(A)$. ^ad636f
