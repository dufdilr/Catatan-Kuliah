...
### Kasus Basis
Misalkan $A$ grup komutatif dengan $\text{ord}(A) = p$. Berdasarkan [[Buat Backup/Semester 5/Struktur Aljabar/Grup/Teorema Lagrange/Grup Siklik Orde Prima|Teorema]], $A$ adalah grup siklik sehingga $A = \left< a \right>$ dan [[Buat Backup/Semester 5/Struktur Aljabar/Grup/Order Unsur Pembangun|berlaku]] $\text{ord}(a) = \text{ord}(A) = p$.
...
Misalkan $A$ grup komutatif dengan $\text{ord}(A) = np$. Ambil $a \in A$ dengan $a \neq e$. Tinjau $B = \left< a \right>$. Karena $A$ grup komutatif maka $B \unlhd A$ dan $A/B$ adalah [[Buat Backup/Semester 5/Struktur Aljabar/Grup/Subgrup Normal/Grup Hasil Bagi]]. Berdasarkan [[Buat Backup/Semester 5/Struktur Aljabar/Grup/Teorema Lagrange/Teorema Lagrange]], berlaku
$$
\text{ord}(B) \cdot \text{ord}(A/B) = \text{ord}(A) = np
$$
Tinjau kasus berikut
* Jika $p \mid \text{ord}(B)$.
[[Buat Backup/Semester 5/Struktur Aljabar/Grup/Order Unsur Pembangun|Maka]], $\text{ord}(B) = \text{ord}(a) = mp$ untuk suatu $m \in \mathbb{N}$. Perhatikan [[Buat Backup/Semester 5/Struktur Aljabar/Grup/Order Pangkat|bahwa]]
$$
\text{ord}(a^m) = \frac{\text{ord}(a)}{(\text{ord}(a), m)} = \frac{mp}{(mp, m)} = \frac{mp}{m} = p
$$
Pilih $x = a^m$. Didapatkan unsur dengan $\text{ord}(x) = p$.
* Jika $p \nmid \text{ord}(B)$. 
Berdasarkan [[Buat Backup/Semester 4/Pengantar Teori Bilangan/Bilangan Bulat/Karakterisasi Bilangan Prima]], maka $p \mid \text{ord}(A/B)$. 
...
(xB)^p = x^pB = eB
$$
Maka $x^p \in x^pB = B$. Misalkan $\text{ord}(x^p) = k$. Berdasarkan [[Buat Backup/Semester 5/Struktur Aljabar/Grup/Order Pangkat]]
$$
...
Berdasarkan [[Buat Backup/Prerquested/Prinsip Induksi Matematika]], terbukti untuk setiap grup $A$ dengan $\text{ord}(A) = np$ untuk suatu $n \in \mathbb{N}$ maka terdapat $g \in A$ sehingga $\text{ord}(g) = p$.
