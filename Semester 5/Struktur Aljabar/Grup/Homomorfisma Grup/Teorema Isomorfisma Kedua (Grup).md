...
---
## Bukti
Berdasarkan [[Buat Backup/Semester 5/Struktur Aljabar/Grup/Subgrup Normal/Subgrup Normal dari Subgrup|teorema]], maka $B\cap N\unlhd B$ dan $BN \unlhd N$. Maka $B/(B \cap N)$ dan $BN/N$ terdefinisi dengan baik sebagai [[Buat Backup/Semester 5/Struktur Aljabar/Grup/Subgrup Normal/Grup Hasil Bagi]].
...
\end{align*}
$$
Terbukti $\mathrm{Inti}(\phi) = B\cap N$. Berdasarkan [[Buat Backup/Semester 5/Struktur Aljabar/Grup/Homomorfisma Grup/Teorema Isomorfisma Pertama (Grup)]] maka
$$
B/(B \cap N)  \cong BN/N
$$
***
