...
Ambil $r_{1}I, r_{2}I \in R/I$ dengan $r_{1}I \neq I$ namun $r_{1}I \cdot r_{2}I=(r_{1}r_{2})I = I$. Berdasarkan [[Buat Backup/Semester 5/Struktur Aljabar/Grup/Teorema Lagrange/Kesamaan Koset]] maka $r_{1}r_{2} \in I$. Karena $r_{1}I \neq I$ [[Buat Backup/Semester 5/Struktur Aljabar/Grup/Teorema Lagrange/Kesamaan Koset|maka]] $r_{1} \notin I$. Karena $I$ adalah ideal prima dengan $r_{1}r_{2}\in I$ namun $r_{1}\notin I$ maka $r_{2}\in I$. Akibatnya $r_{2}I = I$. Berarti $r_{1}I$ bukan [[Buat Backup/Semester 4/Struktur Bilangan Bulat/Daerah Integral/Unsur Pembagi Nol (Ring)|pembagi nol]]. Maka $R/I$ adalah daerah integral.
### $\Rightarrow$
...
$$
Karena $r_{1}\not\in I$ maka $r_{1}I \neq I$. Karena $R/I$ adalah daerah integral maka $r_{2}I = I$. Berdasarkan [[Buat Backup/Semester 5/Struktur Aljabar/Grup/Teorema Lagrange/Kesamaan Koset]] maka $r_{2} \in I$. Per definisi, maka $I$ adalah ideal prima.
