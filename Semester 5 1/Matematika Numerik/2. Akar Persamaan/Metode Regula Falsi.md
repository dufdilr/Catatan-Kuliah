...
Serupa dengan [[Metode Bisection]], metode ini menggunakan konsep memperkecil selang tebakan. Pada metode ini, nilai $c$ bukan nilai tengah melainkan perpotongan garis lurus yang menghubungkan $f(a)$ dan $f(b)$ dengan sumbu-$x$. Dengan kata lain,
